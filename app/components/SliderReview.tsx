...
export default function SliderReview() {
  return (
    <>
      ...
      >
        <SwiperSlide>
          <div className="max-w-6xl m-auto w-full flex items-center justify-between h-full">
            <div className="relative flex items-center">
              <span className="w-[70px] h-[228px] bg-white rounded-4xl absolute"></span>
              <span className="w-[70px] h-[443px] bg-white rounded-4xl absolute left-24"></span>
              <Image
                src={ava}
                alt="ava"
                width={280}
                height={280}
                className="w-[280px] h-[280px] rounded-full relative ml-28 "
              />
            </div>
            <div className="ml-10 text-white max-w-[600px] w-full">
